...
class UserController {
    async addUser(req, res) {
        const { email, _password, first_name, last_name, profile_image, goals, journal, notes, to_do_s } = req.body;
        ...
        [uuidv4(), email, _password, first_name, last_name, profile_image, goals, journal, notes, to_do_s]);
